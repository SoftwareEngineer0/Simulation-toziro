...
namespace Kender.uGUI
{
    ...
    public class ComboBox : MonoBehaviour
    {
        ...
        public bool isCurrentModel = true;
        [SerializeField]
        private bool
            _interactable = true;
        ...
        public bool Interactable
        {
            ...
            set
            {
                ...
                image.color = image.sprite == null ? new Color(1.0f, 1.0f, 1.0f, 0.0f) : _interactable ? button.colors.normalColor : button.colors.normalColor;
        ...
        public void CreateControl()
        {
            ...
            comboButtonColors.disabledColor = new Color32(255, 255, 255, 255);
        ...
        private void InitControl()
        {
            ...
            scrollbarColors.disabledColor = new Color32(255, 255, 255, 255);
        ...
        private void Refresh()
        {
            ...
            for (var i = 0; i < Items.Length; i++)
            {
                ...
                //itemImage.color = item.Image == null ? new Color32(255, 255, 255, 0) : item.IsDisabled ? new Color32(255, 255, 255, 255) : new Color32(255, 255, 255, 255);
        ...
        public void RefreshSelected()
        {
            ...
            comboButtonImage.color = includeImage ? (Interactable ? comboButtonButton.colors.normalColor : comboButtonButton.colors.normalColor) : new Color(1.0f, 1.0f, 1.0f, 0);
